...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-bucket/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet", #Enter subnet
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-bucket/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-bucket/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
...
with DAG('redfin_analytics_spark_job_dag',
        ...
        # Check if an EMR cluster is created.
        ...
        # Add extraction steps to EMR cluster
        ...
        # Add transformation step to EMR cluster.
        ...
        # Check if the transformation is completed.
        ...
        # Terminate the EMR cluster after jobs are done.
        remove_cluster = EmrTerminateJobFlowOperator(
        task_id="tsk_remove_cluster",
        job_flow_id="{{ task_instance.xcom_pull(task_ids='tsk_create_emr_cluster', key='return_value') }}",
        )

        # Check if the termination is completed.
